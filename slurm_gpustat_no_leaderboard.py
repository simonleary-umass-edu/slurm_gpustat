...
def all_info(color: int, verbose: bool, partition: Optional[str] = None):
    ...
    # there used to be summary mode='configured' here, but removed for the users
    summary(mode="up", resources=resources, states=states)
    print(divider)
    available(resources=resources, states=states, verbose=verbose)
    print(divider)
    # there used to be in_use(resources) here but removed for the users
